...
<section>
    <div class="row main-container-about-us" > 
        <h3> We are <b>Dhonism store </b>,Will be Delivering Quality products very soon.</h3>
        <p> Our store is  currently not launched, so please do not order anything. But we'll be back soon.</p>
        
        <div>
            
                <ul class="social-links" style="margin-top:50px;float:left">
